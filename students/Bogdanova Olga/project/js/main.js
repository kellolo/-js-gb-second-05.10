...
////////////////////////////////////
// Функция запрос организованная при помощи функции callback:
function makeGETRequest (url, callback) { 

// нужно использовать эту конструкцию 
...
//функция, которую мы будем вызывать когда получим ответ от сервера
  }
}
//когда запрос завершится, сработает функция 
// 4 - запрос выполнен 

xhr.open('GET', url, true)
//открывает запрос, по какому-то url, true
